    ...
    <div className=' w-full h-[100vh] flex flex-col j items-center font-bold'>
      ...
      <div className=' w-[100%] h-[70vh]  flex flex-col justify-start items-center gap-20 p-4'>
       ...
       <p>Withdraw</p> 
          ...
          <p>Amount</p>
          <input onChange={onChangeHandler} type="number" name='amount' id='amount' placeholder='Amount' className='w-[75%] h-[35px] border border-gray-200 rounded-md p-3'/>
          <button onClick={onClickHandler}>Submit</button>
          {errorMessage && <div style={{ color: 'red' }}>{errorMessage}</div>}
        </div>

      </div>
      <div className='bg-blue-500  w-full h-[200px] flex flex-col justify-center items-center gap-4'>
        footer
      </div>
